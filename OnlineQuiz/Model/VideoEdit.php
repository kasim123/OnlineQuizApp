        ...
        <div id="mainContainer">
            ...
            <div style="width: 650px; height: 400px; margin: 0 auto;">
                ...
                if (isset($_GET['VideoId']) && !empty($_GET['VideoId'])) {
                    ...
                    $query = "SELECT * FROM VideosList WHERE VideoID = $VideoID";
                    $result = mysql_query($query);
                    $res = mysql_fetch_row($result);                    
                }
                ?>
                <span style="font-family: verdana; font-size: 15px; font-weight: bold; margin-left: 210px; text-decoration: underline">
                    Change Video Details to Update
                </span>
                <br/><br/><br/>
                <form name="videoupdate" method="post" action="VideoUpdate.php">
                    <table border="0" cellspacing="4" style="border-collapse: collapse; 
                        ...
                        <tr height="35">
                            ...
                            <td>&nbsp;<input type="text" name="url" id="url" value="<?php echo $res[1]; ?>" size="50" class="textBox2"/></td>
                        </tr>
                        <tr height="35">
                            <td align="right"><strong>Video Thumbnail URL</strong> &nbsp;</td>
                            <td>&nbsp;<input type="text" name="thumnail" id="thumbnail" size="50" value="<?php echo $res[2]; ?>" class="textBox2" /></td>
                        </tr>
                        <tr height="35">
                        ...
                        <tr height="35">
                            ...
                            <td>&nbsp;<textarea name="description" id="description" rows="3" cols="37" style=" border: solid darkgray thin; border-radius: 3px;">
                                <?php echo $res[4]; ?>
                                </textarea></td>
                        </tr>
                        ...
                        <tr height="35">
                            <td align="right">&nbsp;</td>
                            <td>&nbsp;
                                <input type="submit"" name="submit" value="Update Video" class="button" style="width: 150px; height: 28px;"/>
                            </td>
                        </tr>
