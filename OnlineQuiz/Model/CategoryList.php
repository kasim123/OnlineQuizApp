...
<html>
    ...
    <body>
        <div id="mainContainer">
            ...
            <div style="width: 800px; height: 400px; margin: 0 auto; float: right;">
                <br/>
                <?php
                if ($_SESSION['GROUP'] == 'EO') {
                    echo "<a href = 'CategoryNew.php'>";
                    echo "<input type = 'button' value = 'Add New Category' class = 'button' style = 'width: 150px;'/>";
                    echo "</a>";
                }
                ?>
                <p></p>

                <table border="1" style="border-collapse: collapse; border-color: gainsboro; width: 100%; font-family: verdana;">
                    <tr style="font-size: 14px; font-weight: bold; background-color: darkgray; height: 30px; border: solid thin gainsboro">
                        ...
                        <td width="450px">Category Name</td>
                        <td width="50px" align="center">Control</td>
                    </tr> 
                    ...
                    $targetpage = "CategoryList.php";  //your file name  (the name of this file)
                    ...
                    /* Get data. */
                    $sql = "SELECT * FROM $tbl_name ORDER BY CategoryID LIMIT $start, $limit";
                    ...
                    while ($row = mysql_fetch_array($result)) {
                        ...
                        echo "<td>$row[1]</td>";
                        if ($_SESSION['GROUP'] == 'EO') {
                            echo "<td align='center'><a href='CategoryDelete.php?page=$page&Id=$row[0]'><input type='button' value='Delete' class='button' style='height:20px;'/></a></td>";
                        } else {
                            echo "<td>Insufficient Privilege</td>";
                        }
