            ...
            <div style="width: 900px; height: 400px; margin: 0 auto; float: right;">
                ...
                <table border="1" cellspacing="4" style="border-collapse: collapse; border-color: gainsboro; width: 100%; font-family: verdana;">
                    ...
                    $sql = "SELECT VideoID, URL, CategoryName, Description, PostedBy, PostedOn ".
                            ...
                            "AND IsActive=1 ORDER BY PostedOn DESC LIMIT $start, $limit";
                    ...
                    while ($row = mysql_fetch_array($result)) {
                        ...
                        echo "<td rowspan='2' align='center'>
                            <a href='CategoryDelete.php?page=$page&Id=$row[0]'><input type='button' value='Edit' class='button' style='height:20px;'/></a>
                                <a href='CategoryDelete.php?page=$page&Id=$row[0]'><input type='button' value='Delete' class='button' style='height:20px;'/></a>
                                </td>";
                        echo "</tr>";
