            ...
            <div style="width: 900px; height: 400px; margin: 0 auto; float: right;">
                ...
                <table border="1" cellspacing="4" style="border-collapse: collapse; border-color: gainsboro; width: 100%; font-family: verdana;">
                    <tr style="font-size: 14px; font-weight: bold; background-color: darkgray; height: 30px; border: solid thin gainsboro">
                        ...
                        <td width="90px" align="center">Active Status</td>
                    ...
                    $targetpage = "WebUsersList.php";  //your file name  (the name of this file)
                    ...
                    while ($row = mysql_fetch_array($result)) {
                        ...
                        echo "<a href='ChangePassword.php?page=$page&User=$row[0]'><input type='button' value='Change Pass' class='button' style='height:20px; width:100px;'/></a><br><br>";
                        if ($row[10] == 0) {
                            echo "<a href = 'WebUserActivate.php?page=$page&user=$row[1]'><input type = 'button' value = 'Activate' class = 'button' style = 'height:20px; width:100px;'/></a>";
                        } else {
                            echo "<a href = 'WebUserDeactivate.php?page=$page&user=$row[1]'><input type = 'button' value = 'Deactivate' class = 'button' style = 'height:20px; width:100px;'/></a>";
                        }
                        echo "</td>";
                        $i++;
                        echo "</tr>";
