    ...
    <body>
        <div id="mainContainer">
            ...
            <div style="width: 900px; height: 400px; margin: 0 auto; float: right;">
                <br/>
                <a href="VideoPostNew.php">
                    <input type="button" value="Add New Video" class="button" style="width: 150px;"/>
                </a>                
                <a href="SlidePosttNew.php">
                    <input type="button" value="Add New Slide" class="button" style="width: 150px;"/>
                </a>
                <p></p>
                ...
                <table border="1" cellspacing="4" style="border-collapse: collapse; border-color: gainsboro; width: 100%; font-family: verdana;">
                    <tr style="font-size: 14px; font-weight: bold; background-color: darkgray; height: 30px; border: solid thin gainsboro">
                        ...
                        <td width="200px">&nbsp;Video ID</td>
                        <td width="350px">&nbsp;Category Name</td>
                        <td width="350px">&nbsp;Posted By</td>
                        <td width="150px">&nbsp;Posted On</td>
                        <td width="150px" align="center">Control</td>
                    </tr> 

                    <?php
                    include('Connection.php'); // include your code to connect to DB.

                    $tbl_name = "VideosList";  //your table name
                    ...
                    $targetpage = "VideoList.php";  //your file name  (the name of this file)
                    ...
                    /* Get data. */
                    $sql = "SELECT VideoID, URL, CategoryName, Description, PostedBy, PostedOn ".
                            "FROM $tbl_name, Categories WHERE $tbl_name.CategoryID=Categories.CategoryID ".
                            "AND IsActive=0 ORDER BY PostedOn DESC LIMIT $start, $limit";
                    ...
                    while ($row = mysql_fetch_array($result)) {
                        ...
                        echo "<td rowspan='2'>&nbsp;<a href='$row[1]' target='_blank'>VID$row[0]</a></td>";
                        echo "<td>&nbsp;$row[2]</td>";
                        echo "<td>&nbsp;$row[4]</td>";
                        echo "<td>&nbsp;$row[5]</td>";
                        echo "<td rowspan='2' align='center'>
                            <a href='VideoEdit.php?page=$page&VideoId=$row[0]'><input type='button' value='Edit' class='button' style='height:20px;'/></a>
                                <a href='VideoDelete.php?page=$page&VideoId=$row[0]'><input type='button' value='Delete' class='button' style='height:20px;'/></a>
                                    <a href='VideoQuestionNew.php?page=$page&VideoId=$row[0]'><input type='button' value='Add Question' class='button' style='height:20px; width:100px;'/></a>
                                </td>";
                        echo "</tr>";
                        echo "<tr style='font-size:9px; border: solid thin gainsboro'>
                            <td colspan='3'>&nbsp;$row[3]</td></tr>";
                        $i++;
                        
                        echo "<tr style='font-size:13px; border: solid thin gainsboro'><td colspan='6'>&nbsp;</td></tr>";
                    }
                    ?>
